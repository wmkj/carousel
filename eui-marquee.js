...
(function(){
	eui.on(window, 'load', function(){
		eui.createMarquee(document.querySelector('#glmarquee .mq-c'),  
			document.querySelectorAll('#glmarquee .mq-i'),
			document.querySelector('#glmarquee .mq-btn.left'),  
			document.querySelector('#glmarquee .mq-btn.right')
		);
	});
})();
